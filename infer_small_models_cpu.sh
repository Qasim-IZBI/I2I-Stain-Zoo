#!/bin/bash
#SBATCH --job-name=i2i_infer_small_cpu
#SBATCH --output=logs_infer_small_cpu/infer_%A_%a.out
#SBATCH --error=logs_infer_small_cpu/infer_%A_%a.err
...
# Let PyTorch use all allocated CPUs
export OMP_NUM_THREADS=${SLURM_CPUS_PER_TASK}
export MKL_NUM_THREADS=${SLURM_CPUS_PER_TASK}

mkdir -p logs_infer_small_cpu
