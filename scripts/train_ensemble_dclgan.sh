#!/bin/bash
#SBATCH --job-name=i2i_ens_dcl_train
#SBATCH --output=logs_ensemble/dclgan_train_%A_%a.out
#SBATCH --error=logs_ensemble/dclgan_train_%A_%a.err
...
# small DCLGAN: ngf=64, n_blocks=8 (matches train_all_54.sh small config)
NGF=64
NBLOCKS=8

OUTPUT_DIR=/work2/bz66izin-VSproject/ensemble/dclgan/data_large/model_small/models/model_${MEMBER}
