#!/bin/bash
#SBATCH --job-name=i2i_fillholes_ugac
#SBATCH --output=logs_ensemble_ugac/i2i_fillholes_ugac_%A_%a.out
#SBATCH --error=logs_ensemble_ugac/i2i_fillholes_ugac_%A_%a.err
