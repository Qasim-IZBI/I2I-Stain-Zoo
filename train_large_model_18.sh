#!/bin/bash
#SBATCH --job-name=ml_training_large
...
#SBATCH --ntasks=1
#SBATCH --gres=gpu:1
#SBATCH --array=0-17   # 18 jobs = 6 models x 3 data-sizes (large model size only)
...
# -----------------------------
# Hyperparameters by model size (large = index 2)
# -----------------------------
